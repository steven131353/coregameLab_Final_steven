...
public class MapGenerator : MonoBehaviour
{
  ...
  public   void OnNewWave()
    ...
    public void GenerateMap()
    {
        ...
        coordQueue = new Queue<Coord>(ShuffleArray<Coord>(coordList.ToArray(), currentMap.seed));//得到一个打乱的队列 
        ...
        queueTileMap = new Queue<Coord>(ShuffleArray<Coord>(tileMapList.ToArray(), currentMap.seed));
